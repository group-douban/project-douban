                    ...
                    <ul>
                        ...
                        >
                            <div>
                                ...
                                <div>
                                     <van-rate
                                    v-model="yingping.rating.star_count"
                                    :size="10"
                                    color="#ffd21e"
                                    allow-half void-icon="star"
                                    void-color="#eee"
...
export default {
   ...
   created(){
    ...
    async mounted(){
        ...
        //综述数据
        let result = await http.get('/apia/api/v2/movie/1291546?',{
            apiKey : this.apiKey
        })
        ...
        let result2 = await http.get('/apia/api/v2/movie/1291546/photos?',{
            start : this.start,
            count : 18,
            apiKey : this.apiKey
        })
        ...
        //console.log(this.juzhaoList)

        let result3 = await http.get('/apia/api/v2/movie/1291546/interests?',{
            start : this.start,
            count : 4,
            status : 'done',
            apiKey : this.apiKey
       ...
       //const date = this.mainList3.interests[2].  create_time
        ...
        let result4 = await http.get('/apia/api/v2/movie/1291546/recommendations?',{
            start : this.start,
            count : 18,
            apiKey : this.apiKey
        })
