            ...
            <div class="movie">
                ...
                <div class="movie_info">
                    ...
                    <div class="movie_story">
                        {{this.mainList.author[0]}}&nbsp;{{this.mainList.author[1]}}&nbsp;/&nbsp;{{this.mainList.press[0]}}&nbsp;
                        /&nbsp;出版
                        <br>
                        时间：{{this.mainList.pubdate[0]}}
                    </div>
                </div>
            </div>
            <div class="grade">
...
export default {
   ...
   created(){
    ...
    async mounted(){
        ...
        //综述数据
        let result = await http.get('/apia/api/v2/book/' + this.id + '?',{
            apiKey : this.apiKey
        })
        ...
        let result3 = await http.get('/apia/api/v2/book/' + this.id + '/interests?',{
            start : this.start,
            count : 4,
            status : 'done',
            apiKey : this.apiKey
       ...
       //const date = this.mainList3.interests[2].  create_time
        ...
        let result4 = await http.get('/apia/api/v2/book/' + this.id + '/recommendations?',{
            start : this.start,
            count : 18,
            apiKey : this.apiKey
        })
    ...
    methods: {
      ...
      async loadData(){
         let result5 = await http.get('/apia/api/v2/book/' + this.id + '/reviews?',{
