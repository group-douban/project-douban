           ...
           @refresh="onRefresh"
            >
               ...
               > 
                  ...
                  <ul class="mainList">
                     <li
                     v-for='(m,i) in technologyMoviekList'
                     :key = 'm.id'
                     >
                     <!--  <div>
                           NO.{{index+1}}
...
export default {
   ...
   created(){
    ...
    async mounted() {
       let result = await http.get('/apia/api/v2/subject_collection/movie_scifi/items?',{
