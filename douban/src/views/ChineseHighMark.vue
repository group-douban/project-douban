           ...
           @refresh="onRefresh"
            >
               ...
               > 
                  ...
                  <ul class="mainList">
                     <li
                     v-for='(m,i) in chineseHighMarkList'
                     :key = 'm.id'
                     >
                     <!--  <div>
                           NO.{{index+1}}
...
export default {
  ...
  /* https://frodo.douban.com/api/v2/subject_collection/3760/items?start=0&count=20&apiKey=054022eaeae0b00e0fc068c0c0a2102a */
   ...
   created(){
    ...
    async mounted() {
       let result = await http.get('/apia/api/v2/subject_collection/3760/items?',{
