   ...
   <div class="container">
         ...
         <div class="box">
            ...
            >
               ...
               > 
                  <div class="banner">
                     <img :src="this.allList.subject_collection.header_fg_image" alt="">
                  </div>
                  <nav>
                     <ul>
                        <li>看过0部</li>
                        <li>/</li>
                        <li>总共{{this.allList.subject_collection.items_count}}部</li>
                     </ul>
                     <div>
                        <span>生成海报</span>
                     </div>
                  ...
                  <ul class="mainList">
                     ...
                     <!--  <movie-list-button :color='color' :index='i' ></movie-list-button> -->
                        <top250-list-button :index='i' ></top250-list-button>
                     ...
                     <!--  <div>
                        ...
                        <top250-list-evaluate :movie='m'></top250-list-evaluate>
                     </li>
                  </ul>
               </van-list>
            </van-pull-refresh>
...
import Top250ListButton from '@c/MovieList/Top250/Top250ListButton'
import Top250ListEvaluate from '@c/MovieList/Top250/Top250ListEvaluate'
...
export default {
  ...
  /*  https://frodo.douban.com/api/v2/subject_collection/movie_scifi/items?start=0&count=20&apiKey=054022eaeae0b00e0fc068c0c0a2102a */
 /*  https://frodo.douban.com/api/v2/subject_collection/movie_top250/items?start=0&count=20&apiKey=054022eaeae0b00e0fc068c0c0a2102a */

   /* async mounted() {
       let result = await get({url:'/apia/api/v2/subject_collection/movie_top250/items?',
         params:{
               start:0,
               count:20,
       ...
       this.top250 = result.data.subject_collection_items
 ...
 */
   ...
   created(){
    ...
    async mounted() {
       let result = await http.get('/apia/api/v2/subject_collection/movie_top250/items?',{
